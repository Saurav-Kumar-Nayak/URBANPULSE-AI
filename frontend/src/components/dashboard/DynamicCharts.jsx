...
export const DynamicCharts = ({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }} className="command-center-bottom-charts">
        
        {/* Panel 1: AIR QUALITY TREND */}
        <div className="card-panel" style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '12px', background: 'rgba(13, 19, 28, 0.95)' }}>
        ...
        <div className="card-panel" style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '10px', background: 'rgba(13, 19, 28, 0.95)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          {/* 5-Day Strip */}
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: '4px', borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: '6px' }}>
            {weatherCards.map(w => (
