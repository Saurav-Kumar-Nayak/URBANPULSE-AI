    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div className="chart-grid-3col">
          ...
          {/* COLUMN 1: CRITICAL 🔴 */}
          <div className="card-panel equal-height-card" style={{ padding: '20px', borderTop: '4px solid #f43f5e', minHeight: '340px' }}>
            <div>
          ...
          {/* COLUMN 2: WARNING 🟠 */}
          <div className="card-panel equal-height-card" style={{ padding: '20px', borderTop: '4px solid #f59e0b', minHeight: '340px' }}>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
          ...
          {/* COLUMN 3: NORMAL 🟢 */}
          <div className="card-panel equal-height-card" style={{ padding: '20px', borderTop: '4px solid #10b981', minHeight: '340px' }}>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
