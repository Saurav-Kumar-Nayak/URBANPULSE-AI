  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div className="chart-grid-2col">
        {/* Weather vs AQI */}
        <div className="glass-panel equal-height-card" style={{ padding: '20px', minWidth: 0 }}>
          <h3 style={{ fontSize: '0.98rem', fontWeight: 700, marginBottom: '16px' }}>
            Weather Condition vs AQI Correlation
          </h3>
          <div style={{ height: '240px', width: '100%', minWidth: 0, marginTop: 'auto' }}>
            <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="glass-panel equal-height-card" style={{ padding: '20px' }}>
          <h3 style={{ fontSize: '0.98rem', fontWeight: 700, marginBottom: '16px' }}>
            Location Pollution Hierarchy
          </h3>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', height: '240px', overflowY: 'auto', marginTop: 'auto' }}>
